...
class ParallelConfig:
    ...
    """Whether to use a custom profiler."""

    use_s1: bool = False
    """Whether to use S1 energy model."""
    use_s1_dvfs_only: bool = False
    """Whether to use S1 energy model with DVFS only."""
    use_s2: bool = False
    """Whether to use S2 energy model."""
    
    use_window_based_dvfs_only: bool = False
    """Whether to use window-based DVFS only."""
    measure_fidelity: bool = False
    """Whether to measure fidelity of the energy model."""
    
    disagg_mode: bool = False
    """Whether to use disaggregated mode."""
