...
class EngineArgs:
    ...
    custom_profiler: bool = False
    use_s1: bool = False
    use_s1_dvfs_only: bool = False
    use_s2: bool = False
    use_tpot_based: bool = False
    use_window_based_dvfs_only: bool = False
    ...
    def add_cli_args(parser: FlexibleArgumentParser) -> FlexibleArgumentParser:
        ...
        # Energy-inf arguments
        parser.add_argument('--custom-profiler',
                            dest='custom_profiler',
                            action='store_true',
                            default=EngineArgs.custom_profiler,
                            help='Use custom profiler.')
        parser.add_argument('--use-s1',
                            dest='use_s1',
                            action='store_true',
                            default=EngineArgs.use_s1,
                            help='Use S1 energy model.')
        parser.add_argument('--use-s1-dvfs-only',
                            dest='use_s1_dvfs_only',
                            action='store_true',
                            default=EngineArgs.use_s1_dvfs_only,
                            help='Use S1 energy model with DVFS only.')
        parser.add_argument('--use-s2',
                            dest='use_s2',
                            action='store_true',
                            default=EngineArgs.use_s2,
                            help='Use S2 energy model.')
        parser.add_argument('--use-tpot-based',
                            dest='use_tpot_based',
                            action='store_true',
                            default=EngineArgs.use_tpot_based,
                            help='Use TPOT-based scheduling.')
    
        parser.add_argument('--use-window-based-dvfs-only',
                            dest='use_window_based_dvfs_only',
                            action='store_true',
                            default=EngineArgs.use_window_based_dvfs_only,
                            help='Use window-based DVFS only.')
        
        parser.add_argument('--measure-fidelity',
                            dest='measure_fidelity',
                            action='store_true',
                            default=EngineArgs.measure_fidelity,
                            help='Measure fidelity of the energy model.')
        parser.add_argument('--disagg-mode',
                            dest='disagg_mode',
                            action='store_true',
                            default=EngineArgs.disagg_mode,
                            help='Use disaggregated mode.')
    ...
    def create_engine_config(
        ...
        parallel_config = ParallelConfig(
            ...
            custom_profiler=self.custom_profiler,
            use_s1=self.use_s1,
            use_s1_dvfs_only=self.use_s1_dvfs_only,
            use_s2=self.use_s2,
            use_window_based_dvfs_only=self.use_window_based_dvfs_only,
            measure_fidelity=self.measure_fidelity,
