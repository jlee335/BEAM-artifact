...
class EngineCoreClient(ABC):
    ...
    * AsyncMPClient: ZMQ + background proc EngineCore w/ asyncio (for AsyncLLM)
    ...
    def update_tpot_slo(self, tpot_slo: float) -> None:
        raise NotImplementedError

    def update_tbt_slo(self, tbt_slo: float) -> None:
        raise NotImplementedError

    def update_ttft_slo(self, ttft_slo: float) -> None:
        raise NotImplementedError
    ...
    async def profile_async(self, is_start: bool = True, output_dir: str | None = None) -> None:
        raise NotImplementedError

    async def update_chunk_size_async(self, chunk_size: int) -> None:
        raise NotImplementedError

    async def update_microbatch_size_async(self, microbatch_size: int) -> None:
        raise NotImplementedError

    async def update_tpot_slo_async(self, tpot_slo: float) -> None:
        raise NotImplementedError

    async def update_tbt_slo_async(self, tbt_slo: float) -> None:
        raise NotImplementedError

    async def update_ttft_slo_async(self, ttft_slo: float) -> None:
        raise NotImplementedError
...
class InprocClient(EngineCoreClient):
    ...
    def update_chunk_size(self, chunk_size: int) -> None:
        self.engine_core.update_chunk_size(chunk_size)

    def update_microbatch_size(self, microbatch_size: int) -> None:
        self.engine_core.update_microbatch_size(microbatch_size)

    def update_tpot_slo(self, tpot_slo: float) -> None:
        self.engine_core.update_tpot_slo(tpot_slo)

    def update_tbt_slo(self, tbt_slo: float) -> None:
        self.engine_core.update_tbt_slo(tbt_slo)

    def update_ttft_slo(self, ttft_slo: float) -> None:
        self.engine_core.update_ttft_slo(ttft_slo)
...
class SyncMPClient(MPClient):
    ...
    def update_chunk_size(self, chunk_size: int) -> None:
        self.call_utility("update_chunk_size", chunk_size)

    def update_microbatch_size(self, microbatch_size: int) -> None:
        self.call_utility("update_microbatch_size", microbatch_size)

    def update_tpot_slo(self, tpot_slo: float) -> None:
        self.call_utility("update_tpot_slo", tpot_slo)

    def update_tbt_slo(self, tbt_slo: float) -> None:
        self.call_utility("update_tbt_slo", tbt_slo)

    def update_ttft_slo(self, ttft_slo: float) -> None:
        self.call_utility("update_ttft_slo", ttft_slo)
...
class AsyncMPClient(MPClient):
    ...
    async def profile_async(self, is_start: bool = True, output_dir: str | None = None) -> None:
        await self.call_utility_async("profile", is_start, output_dir)

    async def update_chunk_size_async(self, chunk_size: int) -> None:
        await self.call_utility_async("update_chunk_size", chunk_size)

    async def update_microbatch_size_async(self, microbatch_size: int) -> None:
        await self.call_utility_async("update_microbatch_size", microbatch_size)

    async def update_tpot_slo_async(self, tpot_slo: float) -> None:
        await self.call_utility_async("update_tpot_slo", tpot_slo)

    async def update_tbt_slo_async(self, tbt_slo: float) -> None:
        await self.call_utility_async("update_tbt_slo", tbt_slo)

    async def update_ttft_slo_async(self, ttft_slo: float) -> None:
        await self.call_utility_async("update_ttft_slo", ttft_slo)
